...
const styles = StyleSheet.create({
  ...
  percent: { color: C.paper, fontSize: 18, fontWeight: '600' },
  ...
  progressButtonText: { color: C.paper, fontWeight: '700', fontSize: 12 },
  ...
  link: { color: C.paper, fontWeight: '700', marginTop: 14, fontSize: 12 },
});
